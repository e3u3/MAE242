...
def makeValues(values,xI,xG,n,m,O, LOSESTATES):
    minval = 0
    maxval = 0
    ...
    gridvalues[xG[0][1]][xG[0][0]] = [0.,1.,0.] # Goal node (plotted as green)
    gridvalues[xG[1][1]][xG[1][0]] = [0., 1., 0.]  # Goal node (plotted as green)
    for x in LOSESTATES:
        gridvalues[x[1]][x[0]] = [1.0,0.0,0.0]
    return gridvalues
